👋  Hi there! i'm I am a __software engineer interested in big data.__

On the backend side, I mainly use Django and Spring, also I studying NestJS.

Also on the other side ( ex mobile, frontend etc..) , I can use Vue.js and Flutter.
